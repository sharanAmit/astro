...
class AstroDetailCallCard extends StatelessWidget {
  AstroDetailCallCard({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return ListView(
        ...
        children: [
          for (int index = 0;
              index < callController.filteredAstro.length;
              index++)
            Padding(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  callController.filteredAstro[index].rating
                                      .toString(),
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                      callController.filteredAstro[index]
                                          .astrologerFirstName,
                                      style: GoogleFonts.urbanist(
                                          color: primaryColor1,
                                          fontSize: 18.sp,
                              ...
                              Row(
                                children: [
                                  for (int i = 0;
                                      ...
                                      i++)
                                    Text(
                                        "${callController.filteredAstro[index].skills[i]}, ",
                                        style: GoogleFonts.urbanist(
                                            color: blackcolor,
                                            fontSize: 11.sp,
                                            letterSpacing: 1.1)),
                              ...
                              Row(
                                children: [
                                  for (int i = 0;
                                      ...
                                      i++)
                                    Text(
                                        "${callController.filteredAstro[index].languages[i]}, ",
                                        style: GoogleFonts.urbanist(
                                            color: blackcolor,
                                            fontSize: 11.sp,
                                            letterSpacing: 1.1)),
                              ...
                              Text(
                                  callController.filteredAstro[index].experience
                                      .toString(),
                                  style: GoogleFonts.urbanist(
                                      color: blackcolor,
                                      fontSize: 11.sp,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${callController.filteredAstro[index].chatPrice}/min",
                              style: GoogleFonts.urbanist(
