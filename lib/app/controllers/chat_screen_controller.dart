...
class ChatScreenController extends GetxController {
  ...
  final user = const types.User(id: '82091008-a484-4a89-ae75-a22bf8d6f3ac').obs;
  ...
  void loadMessages() async {
    ...
    final message = (jsonDecode(response) as List)
  ...
  showRatingDialog() {
    Get.dialog(
      RatingDialog(
        submitButtonTextStyle: GoogleFonts.urbanist(
          color: primaryColor,
          fontSize: 15,
